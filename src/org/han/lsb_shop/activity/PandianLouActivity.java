...
import org.han.lsb_shop.adapter.PandianLouAdapter;
...
public class PandianLouActivity extends Activity implements OnClickListener,IXListViewListener, Callback{
	...
	private PandianLouAdapter adapter;
	...
	private TextView xuhao,guizu,bianma,mingcheng,danwei;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_pandian_lou);
		
		myapp = (MyApplication) getApplication();
		handler = new Handler(this);
		dlg_progressbar = new AlertDialog.Builder(PandianLouActivity.this).create();
		
		findViewById(R.id.btn_back).setOnClickListener(this);
		
		WindowManager wm = this.getWindowManager();
		width = wm.getDefaultDisplay().getWidth();
		xuhao = (TextView)findViewById(R.id.xuhao);
		...
		xuhao.setWidth(width/100*10);
		guizu.setWidth(width/100*15);
		...
		adapter = new PandianLouAdapter(PandianLouActivity.this, lists, this);
	...
	public boolean handleMessage(Message msg) {
		...
		case TRUE:
			...
			try {
				...
				map.put("danwei", String.valueOf(352));
				...
				Loger.e("TAG", e);
				Toast.makeText(PandianLouActivity.this, "服务器返回异常",
