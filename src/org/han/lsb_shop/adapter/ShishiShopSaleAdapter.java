...
public class ShishiShopSaleAdapter extends BaseAdapter {
    ...
    public ShishiShopSaleAdapter(Context context, List<Map<String, String>> listItems,OnClickListener listener) {   
    ...
    public View getView(int position, View convertView, ViewGroup parent) { 
		...
		holder.mendian_db.setText(listItems.get(position).get("bumen"));
		holder.shuliang_db.setText(listItems.get(position).get("shuliang"));
		holder.shouru_db.setText(listItems.get(position).get("shouru"));
		holder.chengben_db.setText(listItems.get(position).get("chengben"));
		holder.maoli_db.setText(listItems.get(position).get("maoli"));
